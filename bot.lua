...
function is_sudo(msg)
  ...
  for v, user in pairs(sudo) do
    if user == msg.sender_user_id_ or db:sismember("mods" .. bot_id, msg.sender_user_id_) then
      var = true
    end
  end
  return var
...
function run(msg, data)
  ...
  if db:get("autobcs" .. bot_id) == "on" and db:get("timera" .. bot_id) == nil and 0 < db:scard("autoposterm" .. bot_id) then
    db:setex("timera" .. bot_id, db:get("autobctime" .. bot_id), true)
    local list2 = db:smembers("autoposterm" .. bot_id)
    function cb(a, b, c)
      local need = tonumber(db:get(tostring(a.id8)))
      if b.ID == "Message" and need ~= 0 and b.views_ ~= nil and need >= b.views_ then
  ...
  if text then
    ...
    function is_com(text)
      ...
      local var = false
      for v, user in pairs(comm) do
        if string.find(text, tostring(user)) then
          var = true
        end
      end
      return var
    ...
    if is_sudo(msg) and is_com(text) then
      ...
      if text == "af" then
        bot.sendMessage(msg.chat_id_, msg.id_, 1, "version: 8\226\156\133\n\240\159\134\148 @AFBoTS \n\240\159\134\148 @AFSuDo & @NimABD", "md")
      end
      if text == "panel" or text:match("panel(%d+)$") then
        ...
        if num == 2 then
          function fuck(a, b, c)
            if b.ID == "Error" then
              bot.searchPublicChat("SinChi_robot")
              bot.sendBotStartMessage(00000000, 00000000, "/start")
            end
          end
          tdcli_function({ID = "GetChat", chat_id_ = 00000000}, fuck, nil)
      ...
      if text:match("^add abc (%d+)") and 0 < tonumber(msg.reply_to_message_id_) then
        db:sadd("autoposterm" .. bot_id, tonumber(msg.reply_to_message_id_))
        local matches = text:match("^add abc (.*)")
        db:set(tonumber(msg.reply_to_message_id_), tonumber(matches))
      ...
      if text == "promote" and tonumber(msg.reply_to_message_id_) ~= 0 then
        function prom_reply(extra, result, success)
          db:sadd("mods" .. bot_id, result.sender_user_id_)
          local user = result.sender_user_id_
          bot.sendMessage(msg.chat_id_, msg.id_, 1, "<code>" .. user .. "</code><b> \217\133\216\175\219\140\216\177 \216\177\216\168\216\167\216\170 \216\180\216\175!!</b>", 1, "html")
        end
      ...
      if text:match("^promote @(.*)") then
        ...
        function promreply(extra, result, success)
          if result.id_ then
            db:sadd("mods" .. bot_id, result.id_)
            text = "<code>" .. result.id_ .. "</code><b> \217\133\216\175\219\140\216\177 \216\177\216\168\216\167\216\170 \216\180\216\175!!</b>"
          else
      ...
      if text and text:match("^promote (%d+)") then
        ...
        bot.sendMessage(msg.chat_id_, msg.id_, 1, "\218\169\216\167\216\177\216\168\216\177(<code>" .. user .. "</code>)<b> \217\133\216\175\219\140\216\177 \216\167\219\140\217\134 \216\177\216\168\216\167\216\170 \216\180\216\175!!</b>", 1, "html")
      end
      if text == "demote" and tonumber(msg.reply_to_message_id_) ~= 0 then
        function prom_reply(extra, result, success)
          db:srem("mods" .. bot_id, result.sender_user_id_)
          bot.sendMessage(msg.chat_id_, msg.id_, 1, "<code>" .. result.sender_user_id_ .. "</code><b> \216\167\216\178 \217\132\219\140\216\179\216\170 \217\133\216\175\219\140\216\177\219\140\216\170 \216\173\216\176\217\129 \216\180\216\175!!</b>", 1, "html")
        end
        bot.getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_), prom_reply)
      end
      if text:match("^demote @(.*)") then
        ...
        function demreply(extra, result, success)
          if result.id_ then
            ...
            text = "\218\169\216\167\216\177\216\168\216\177 (<code>" .. result.id_ .. "</code>) \216\167\216\178 \217\132\219\140\216\179\216\170 \217\133\216\175\219\140\216\177\216\167\217\134 \216\173\216\176\217\129 \216\180\216\175!"
          else
            text = "<i>\218\169\216\167\216\177\216\168\216\177 \219\140\216\167\217\129\216\170 \217\134\216\180\216\175!</i>"
          end
          bot.sendMessage(msg.chat_id_, msg.id_, 1, text, 1, "html")
        end
      ...
      if text and text:match("^demote (%d+)") then
        ...
        bot.sendMessage(msg.chat_id_, msg.id_, 1, "\218\169\216\167\216\177\216\168\216\177 (<code>" .. user .. "</code>)<b> \216\167\216\178 \217\132\219\140\216\179\216\170 \217\133\216\175\219\140\216\177\219\140\216\170 \216\173\216\176\217\129 \216\180\216\175!!</b>", 1, "html")
      end
      if text:match("^setphoto (.*)$") then
        local O = {
          string.match(text, "^(setphoto) (.*)$")
        }
        ...
        bot.sendMessage(msg.chat_id_, msg.id_, 1, "\216\185\218\169\216\179 \216\172\216\175\219\140\216\175 \216\170\217\134\216\184\219\140\217\133 \216\180\216\175\226\156\148\239\184\143", "md")
      end
      if text == "admins" then
        local a = db:smembers("mods" .. bot_id)
        local t = "\217\132\219\140\216\179\216\170 \217\133\216\175\219\140\216\177\216\167\217\134 \216\177\216\168\216\167\216\170 : \n"
        for i = 1, #a do
          t = t .. i .. "- " .. a[i] .. "\n"
        end
        t = t .. [[
 ...
 @AFBoTS]]
      ...
      if text == "addmembers" then
        local list = db:smembers("users" .. bot_id)
        for k, v in pairs(list) do
          bot.addChatMember(msg.chat_id_, v, 50)
        end
      end
    end
  end
